 ...
 *
 * Disassembly of ssdt9.dat, Tue Feb 25 03:30:33 2020
 *
    ...
    Scope (\_SB.PCI0.SAT0)
    {
        ...
        Scope (PRT2)
        {
            Method (_SDD, 1, NotSerialized)  // _SDD: Set Device Data
            {
                ...
                STFF = FFS0 /* \_SB_.PCI0.SAT0.PRT2._SDD.FFS0 */
            }
        ...
        Scope (PRT3)
        {
            Method (_SDD, 1, NotSerialized)  // _SDD: Set Device Data
            {
                ...
                STFF = FFS0 /* \_SB_.PCI0.SAT0.PRT3._SDD.FFS0 */
            }
        ...
        Scope (PRT4)
        {
            Method (_SDD, 1, NotSerialized)  // _SDD: Set Device Data
            {
                ...
                STFF = FFS0 /* \_SB_.PCI0.SAT0.PRT4._SDD.FFS0 */
            }
        ...
        Scope (PRT5)
        {
            Method (_SDD, 1, NotSerialized)  // _SDD: Set Device Data
            {
                ...
                STFF = FFS0 /* \_SB_.PCI0.SAT0.PRT5._SDD.FFS0 */
            }
