 ...
 *
 * Disassembly of ssdt6.dat, Tue Feb 25 03:30:33 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "INTEL", "xh_cfhd4", 0x00000000)
{
    ...
    Scope (\_SB.PCI0.XHC.RHUB)
    {
        ...
        Method (DETC, 0, NotSerialized)
        {
            If ((\_SB.GGIV (0x030A0016) == Zero))
            {
                CopyObject (H4NC, H4TC) /* \_SB_.PCI0.XHC_.RHUB.H4TC */
                CopyObject (H4NR, H4CR) /* \_SB_.PCI0.XHC_.RHUB.H4CR */
            }
        }
    }
